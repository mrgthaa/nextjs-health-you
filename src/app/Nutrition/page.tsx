    ...
    <StyledBackground $dark={darkMode}>
      ...
      <Box sx={{ position:'absolute', top:16, right:16, display:'flex', gap:1 }}>
        ...
        <Menu
          ...
          PaperProps={{ sx:{ ...glass, background: darkMode ? '#102127':'#5d80c1', color:'#FFD700' } }}
        >
          {[{l:'Data Diri',h:'/profile'},{l:'Notifikasi Kesehatan',h:'/Reminders'},{l:'Media Sosial',h:'/social'}]
            .map(i=>(
      ...
      <PageCard>
        <Typography
          ...
          fontWeight={800}
          textAlign="center"
          sx={{ background:'linear-gradient(90deg,#fff,#fff)', WebkitBackgroundClip:'text', WebkitTextFillColor:'transparent' }}
          gutterBottom
        >
          Menu Sehat Hari Ini
        </Typography>
        ...
        {todayMenu && (
          <>
            <Typography variant="subtitle1" fontWeight={700} textAlign="center" sx={{ color:'#FFD700', mb:2 }}>
              {todayMenu.hari}
            </Typography>
            ...
            {/* tabel mingguan */}
            <Box mt={4}>
              <Typography variant="subtitle2" fontWeight={700} sx={{ color:'#FFD700', mb:1 }}>
              ...
              <Box sx={{ overflowX:'auto' }}>
                <Table size="small" sx={{
                  ...
                  '& tr:nth-of-type(odd)':{ background:'rgba(255,255,255,0.05)' },
                }}>
                  <TableHead>
                    <TableRow>
                  ...
                  <TableBody>
                    {(Object.keys(dailyMenus) as Hari[]).map(h=>(
                      <TableRow key={h}>
                        <TableCell sx={{ fontWeight:700, color:'#FFD700', whiteSpace:'nowrap' }}>{h}</TableCell>
